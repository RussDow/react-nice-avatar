...
export const defaultOptions: DefaultOptions = {
  ...
  hatStyle: ["none"],
  eyeBrowWoman: ["up", "upWoman", "down", "downWoman"],
  eyeStyle: ["circle", "oval", "smile", "shadow"],
  glassesStyle: ["round", "square", "none"],
  noseStyle: ["short", "long", "round"],
  mouthStyle: ["laugh", "smile", "peace", "surprised", "nervous"],
  shirtStyle: ["hoody", "short", "polo"],
  shirtColor: ["#9287FF", "#6BD9E9", "#FC909F", "#F4D150", "#77311D"],
  bgColor: ["#FF5800", "#DC4600"],
  gradientBgColor: [
    "linear-gradient(45deg, #ffD700 0%, #ff5800 100%)",
    "linear-gradient(45deg, #ffb414 0%, #ff5800 100%)",
    "linear-gradient(45deg, #ff5800 0%, #b43c14 100%)",
